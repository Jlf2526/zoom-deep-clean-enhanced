...
Examples:
  ...
  %(prog)s --comprehensive --system-reboot
    ...
    parser.add_argument('--install-fresh', action='store_true',
                       help='Download and install fresh Zoom after cleaning (requires --comprehensive)')
    parser.add_argument('--system-reboot', action='store_true',
    ...
    parser.add_argument('--zoomfixer-mode', action='store_true',
    ...
    parser.add_argument('--randomize-hostname', action='store_true',
                       help='Randomize system hostname for complete device identity reset')
    
    # Legacy options for compatibility
    parser.add_argument('--vm-aware', action='store_true',
