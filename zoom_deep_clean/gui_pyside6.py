...
try:
    from PySide6.QtWidgets import (
        ...
        QDialog, QDialogButtonBox, QFrame, QSpacerItem, QSizePolicy
    )
...
class ModernZoomCleanerGUI(QMainWindow):
    ...
    def load_configuration(self):
        ...
        if filename:
            try:
                ...
                self.performance_monitoring_cb.setChecked(config.get('enable_performance_monitoring', True))
    ...
    def save_report(self):
        ...
        QMessageBox.information(self, "Info", "Report saving will be implemented with cleanup results")
...
"""
    ...
    def show_about(self):
        """Show about dialog"""
        QMessageBox.about(self, "About Zoom Deep Clean Enhanced", 
