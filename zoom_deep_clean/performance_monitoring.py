...
class PerformanceMonitor:
    ...
    def get_performance_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'system_impact': {
                ...
                'avg_memory_change': sum(memory_usages) / len(memory_usages) if memory_usages else 0,
    ...
    def _generate_performance_recommendations(self) -> List[str]:
        ...
        if avg_duration > 30:  # Operations taking more than 30 seconds on average
            recommendations.append("Consider running cleanup in smaller batches to improve responsiveness")
        ...
        if failure_rate > 10:
            recommendations.append("High failure rate detected - consider running with --dry-run first")
        ...
        if max_cpu_change > 50:
            recommendations.append("High CPU usage detected - consider running during off-peak hours")
...
class OptimizationEngine:
    ...
    def optimize_operation_order(self, operations: List[str]) -> List[str]:
        ...
        optimized_operations = sorted(
            operations,
            key=lambda op: avg_durations.get(op, float('inf'))
        )
    ...
    def _wait_for_resources(self):
        ...
        while time.time() - wait_start < max_wait_time:
            ...
            try:
                ...
                if (cpu_percent <= self.resource_limits['max_cpu_percent'] and 
